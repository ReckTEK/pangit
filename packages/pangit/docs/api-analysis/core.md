...
| ------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------ |
| List repositories         | `userCurrentListRepos` / `userListRepos` / `orgListRepos` | `reposListForOrg`                                                        | `getApiV4GroupsIdProjects`                                                                                                                   | `getRepositoriesWorkspace`                                           | `repositoriesList`                               |
| Get repository            | `repoGet`                                                 | `reposGet`                                                               | `getApiV4ProjectsId`                                                                                                                         | `getRepositoriesWorkspaceRepoSlug`                                   | `repositoriesGetRepository`                      |
| Create repository         | `createCurrentUserRepo` / `createOrgRepo`                 | `reposCreateInOrg`                                                       | `postApiV4Projects`                                                                                                                          | `postRepositoriesWorkspaceRepoSlug`                                  | `repositoriesCreate`                             |
