...
const azureDevOpsOperationsSource = {
  ...
  commitsGetCommits: {
    ...
    queryParameters: [
      ...
      { "name": "searchCriteria.compareVersion.versionOptions", "style": "form", "explode": true },
  ...
  pullRequestCommitsGetPullRequestIterationCommits: {
    ...
    pathParameters: [{ "name": "iterationId" }, { "name": "organization" }, { "name": "project" }, {
      "name": "pullRequestId",
    }, { "name": "repositoryId" }],
    queryParameters: [{ "name": "api-version", "style": "form", "explode": true }, {
      "name": "skip",
...
export const azureDevOpsOperations: typeof azureDevOpsOperationsSource = deepFreezeRestOperations(
  azureDevOpsOperationsSource,
);
