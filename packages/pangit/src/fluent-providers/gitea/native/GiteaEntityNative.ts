...
export type GiteaClient<TVersion extends GiteaVersion> = GiteaClientVersions[TVersion];
...
export interface GiteaClientVersions {
  readonly "1.26.4": Client126;
  readonly "1.27.2": Client127;
}
