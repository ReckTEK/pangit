...
import {
  createForgejoIssueEntityNative,
  type ForgejoIssueEntityPayload,
} from "../native/ForgejoIssueNative.ts";
...
export function normalizeForgejoIssue<TVersion extends ForgejoVersion>(
  ...
  return Object.freeze({
    ...
    native: createForgejoIssueEntityNative(
      "issue",
      client,
      payload as ForgejoIssueEntityPayload<TVersion, "issue">,
    ),
  });
}
...
export function normalizeForgejoIssueComment<TVersion extends ForgejoVersion>(
  ...
  return Object.freeze({
    ...
    native: createForgejoIssueEntityNative(
      "issueComment",
      client,
      payload as ForgejoIssueEntityPayload<TVersion, "issueComment">,
    ),
  });
}
