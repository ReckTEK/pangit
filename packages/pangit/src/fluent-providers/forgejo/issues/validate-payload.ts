...
import type { ForgejoIssueEntityPayload } from "../native/ForgejoIssueNative.ts";

export type AnyForgejoIssue = ForgejoIssueEntityPayload<ForgejoVersion, "issue">;

export type AnyForgejoComment = ForgejoIssueEntityPayload<ForgejoVersion, "issueComment">;

export function requireIssueArray<TVersion extends ForgejoVersion>(
...
export function requireCommentArray<TVersion extends ForgejoVersion>(
  context: ForgejoAdapterContext<TVersion>,
  operation: string,
  response: AnyRestResponse,
): readonly AnyForgejoComment[] {
...
export function isIssuePayload(value: unknown): value is AnyForgejoIssue {
...
export function isCommentPayload(value: unknown): value is AnyForgejoComment {
