...
export type GiteaOrganizationPayload<TVersion extends GiteaVersion> = TVersion extends "1.26.4"
  ? import("../../generated-rest-clients/gitea/1.26.4/mod.ts").Organization
  : TVersion extends "1.27.2"
    ? import("../../generated-rest-clients/gitea/1.27.2/mod.ts").Organization
  : never;
...
export type GiteaUserPayload<TVersion extends GiteaVersion> = TVersion extends "1.26.4"
  ? import("../../generated-rest-clients/gitea/1.26.4/mod.ts").User
  : TVersion extends "1.27.2" ? import("../../generated-rest-clients/gitea/1.27.2/mod.ts").User
  : never;
