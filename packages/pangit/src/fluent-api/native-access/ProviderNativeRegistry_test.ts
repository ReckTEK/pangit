...
} from "./ProviderNativeRegistry.ts";
...
type RegistryAssertions = readonly [
  Assert<Equal<ProviderNativeRegistry["gitea"]["1.26.4"], ExpectedGiteaRegistry<"1.26.4">>>,
  Assert<Equal<ProviderNativeRegistry["gitea"]["1.27.2"], ExpectedGiteaRegistry<"1.27.2">>>,
