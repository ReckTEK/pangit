/** Shared native-Fetch transport and stable public REST facade. */
import {
...
import {
  ...
  serializeBody,
  snapshotQuery,
} from "./rest/request.ts";
import { isMultipart } from "./rest/media-type.ts";
import { decodeRestResponse, responseAcceptHeader } from "./rest/response.ts";
import type {
  AnyRestResponse,
  RestClientOptions,
  RestHeadersProvider,
...
export {
  ...
  unwrapRestResponse,
} from "./rest/response.ts";
export type { RestDocumentedSuccess, RestDocumentedSuccessBody } from "./rest/response.ts";
