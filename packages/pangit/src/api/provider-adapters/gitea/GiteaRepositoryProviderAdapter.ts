...
import type { AnyRestResponse } from "../../../providers/runtime/mod.ts";
import { unwrapRestResponse } from "../../../providers/runtime/mod.ts";
import type {
...
export class GiteaRepositoryProviderAdapter<TVersion extends GiteaVersion>
  implements RepositoryProviderAdapter<"gitea", TVersion> {
  ...
  async authorizeToken(
    ...
    tokenType = "token",
    signal?: AbortSignal,
  ): Promise<GiteaRepositoryProviderAdapter<TVersion>> {
