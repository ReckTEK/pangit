...
export type UnsupportedGiteaModulesContractInput<
...
/** Prove Gitea's unsupported optional families are static metadata, not callable probes. */
export async function runUnsupportedGiteaModulesContract<
  const TProvider extends FluentProvider,
  const TVersion extends ProviderVersion<TProvider>,
>(
  t: Deno.TestContext,
  input: UnsupportedGiteaModulesContractInput<TProvider, TVersion>,
  ...
  return Object.freeze({
    id: "shared-capability/unsupported-gitea-modules",
    passed,
