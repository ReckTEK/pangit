import { runForgejoNativeEntityAccessContract } from "../../native-access/entities/forgejo-native-entity-access-contract.ts";
import type { ForgejoContractCatalogEntry } from "../context.ts";
export const runNativeAccessForgejoEntities: ForgejoContractCatalogEntry["run"] = async (
  t,
  context,
) => {
  ...
  return await runForgejoNativeEntityAccessContract(t, {
