...
import { allocateOperationNames, namesForProvider, requiredName } from "./rest-client-manifests.ts";
import type { ProviderPublicNames } from "./rest-client-manifests.ts";
